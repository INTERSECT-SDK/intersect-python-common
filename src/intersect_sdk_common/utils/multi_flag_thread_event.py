"""Generic utility class which can set a flag when used alongside multiple threading events.

Please note that you will need to keep track of the "nth_flag" values you set in set_nth_flag and unset_nth_flag, and will also need to keep track of the parameter provided in the constructor.
"""
