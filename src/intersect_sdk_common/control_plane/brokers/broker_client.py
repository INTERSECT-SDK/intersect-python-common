"""Generic interface we use for interacting with all protocols.

This interface assumes a pub/sub model, but otherwise is agnostic to protocol. This interface should be used only for core services and the SDK, not developers building off of the SDK.
"""
