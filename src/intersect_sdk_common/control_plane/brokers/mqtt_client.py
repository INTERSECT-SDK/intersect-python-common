"""This module handles ALL MQTT protocol logic in INTERSECT. We seek to entirely abstract protocols away from users.

This is a very specific pub-sub model which assumes a single topic exchange.
MQTT topics in INTERSECT generally look like ${ORGANIZATION}.${FACILITY}.${SYSTEM}.${SUBSYSTEM}.${SERVICE}.${MESSAGE_TYPE} . (TODO change to ${SYSTEM}.${SERVICE}.${MESSAGE_TYPE})
