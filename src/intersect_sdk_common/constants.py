...
NOTE: for future compatibility reasons, we are NOT specifying the number of "parts" (separated by a '/') in this regex. All that matters is that you don't start or end with a separator, or start with a hyphen.
"""
